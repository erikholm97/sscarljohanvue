...
export default {
    ...
    beforeRouteEnter(to, from, next) {
        db.collection("Poems")
            ...
            .then(querySnapshot => {
                //We could fix this, through an auto incr, but firebase doesn't have that. Cuz fuck u
                querySnapshot.forEach(doc => {
                    //Anyway, this shit gets the data from Firebase, before we enter this subpage.
                    next(vm => {
